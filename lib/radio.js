...
Radio.prototype.newDJ = function(dj, show){
  var self = this;
  if (dj && dj !== ""){
    self.currentDJ =  dj;
  }
...
Radio.prototype.newTrack = function(title){
  ...
  var data = {track: self.currentTrack, dj: self.currentDJ, show: self.currentShow, token: self.app.settings.server.keys.token}
  request.post(
